...
(function($) {
	var colpick = function() {
		var tpl = '<div class="colpick"><div class="colpick_color"><div class="colpick_color_overlay1"><div class="colpick_color_overlay2"><div class="colpick_selector_outer"><div class="colpick_selector_inner"></div></div></div></div></div><div class="colpick_hue"><div class="colpick_hue_arrs"><div class="colpick_hue_larr"></div><div class="colpick_hue_rarr"></div></div></div><div class="colpick_new_color"></div><div class="colpick_current_color"></div><div class="colpick_hex_field"><div class="colpick_field_letter">#</div><input type="text" maxlength="6" size="6" /></div><div class="colpick_rgb_r colpick_field"><div class="colpick_field_letter">R</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_g colpick_field"><div class="colpick_field_letter">G</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_h colpick_field"><div class="colpick_field_letter">H</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_s colpick_field"><div class="colpick_field_letter">S</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_submit"></div></div>', defaults = {
			...
			$(cal).data("colpick").fields.eq(1).val(rgb.r).end().eq(2).val(
					rgb.g).end().eq(3).val(rgb.b).end()
		}, fillHSBFields = function(hsb, cal) {
			$(cal).data("colpick").fields.eq(4).val(Math.round(hsb.h)).end()
					.eq(5).val(Math.round(hsb.s)).end().eq(6).val(
							Math.round(hsb.b)).end()
			...
			$(cal).data("colpick").selectorIndic
					.css({
						left : parseInt($(cal).data("colpick").height * hsb.s
								/ 100, 10),
						top : parseInt($(cal).data("colpick").height
								* (100 - hsb.b) / 100, 10)
					})
		}, setHue = function(hsb, cal) {
			$(cal).data("colpick").hue.css("top", parseInt($(cal).data(
					"colpick").height
			...
			cal.data("colpick").onChange.apply(cal.parent(), [ col,
					hsbToHex(col), hsbToRgb(col), cal.data("colpick").el, 0 ])
		}, blur = function(ev) {
			$(this).parent().removeClass("colpick_focus")
		}, focus = function() {
			$(this).parent().parent().data("colpick").fields.parent()
			...
			var pageY = ((ev.type == "touchstart") ? ev.originalEvent.changedTouches[0].pageY
					: ev.pageY);
			change
					.apply(
							current.cal.data("colpick").fields
									...
									.val(
											parseInt(
													360
															* (current.cal
																	.data("colpick").height - (pageY - current.y))
															/ current.cal
																	.data("colpick").height,
													10)).get(0), [ current.cal
									.data("colpick").livePreview ]);
			return false
		}, moveHue = function(ev) {
			var pageY = ((ev.type == "touchmove") ? ev.originalEvent.changedTouches[0].pageY
					: ev.pageY);
			change.apply(ev.data.cal.data("colpick").fields.eq(4).val(
					parseInt(360
							* (ev.data.cal.data("colpick").height - Math.max(0,
									Math.min(
											ev.data.cal.data("colpick").height,
											(pageY - ev.data.y))))
							/ ev.data.cal.data("colpick").height, 10)).get(0),
					[ ev.data.preview ]);
			return false
		}, upHue = function(ev) {
							...
							current.cal.data("colpick").fields
									...
									.val(
											parseInt(
													100
															* (current.cal
																	.data("colpick").height - (pageY - current.pos.top))
															/ current.cal
																	.data("colpick").height,
													10))
									.end()
			...
			change.apply(ev.data.cal.data("colpick").fields.eq(6).val(
					parseInt(100
							* (ev.data.cal.data("colpick").height - Math.max(0,
									Math.min(
											ev.data.cal.data("colpick").height,
					...
					.eq(5).val(
							parseInt(100
									* (Math.max(0, Math.min(ev.data.cal
											.data("colpick").height,
			...
			cal.data("colpick").onSubmit(col, hsbToHex(col), hsbToRgb(col),
					cal.data("colpick").el)
		}, show = function(ev) {
			if (ev) {
				ev.stopPropagation()
			...
			if (ev.data.cal.data("colpick").onHide.apply(this, [ ev.data.cal
					.get(0) ]) != false) {
				ev.data.cal.hide()
			}
		...
		return {
			init : function(opt) {
				...
				if (typeof opt.color == "string") {
					...
					if (opt.color.r != undefined && opt.color.g != undefined
							&& opt.color.b != undefined) {
						opt.color = rgbToHsb(opt.color)
					} else {
						if (opt.color.h != undefined
				...
				return this
						.each(function() {
							if (!$(this).data("colpickId")) {
								...
								if (options.polyfill && options.input
										&& this.type === "color") {
									return
								}
								...
								cal.addClass("colpick_"
										+ options.layout
										+ (options.submit ? "" : " colpick_"
												+ options.layout + "_ns"));
								if (options.colorScheme != "light") {
									cal.addClass("colpick_"
											+ options.colorScheme)
								}
								cal.find("div.colpick_submit").html(
										options.submitText).click(clickSubmit);
								options.fields = cal.find("input").change(
										change).blur(blur).focus(focus);
								cal.find("div.colpick_field_arrs").mousedown(
										downIncrement).end().find(
										"div.colpick_current_color").click(
										restoreOriginal);
								...
								options.selectorIndic = options.selector
										.find("div.colpick_selector_outer");
								options.el = this;
								options.hue = cal.find("div.colpick_hue_arrs");
								var huebar = options.hue.parent();
								var UA = navigator.userAgent.toLowerCase();
								var isIE = navigator.appName === "Microsoft Internet Explorer";
								var IEver = isIE ? parseFloat(UA
										.match(/msie ([0-9]{1,}[\.0-9]{0,})/)[1])
										: 0;
								var ngIE = (isIE && IEver < 10);
								var stops = [ "#ff0000", "#ff0080", "#ff00ff",
										"#8000ff", "#0000ff", "#0080ff",
										"#00ffff", "#00ff80", "#00ff00",
										"#80ff00", "#ffff00", "#ff8000",
										"#ff0000" ];
								if (ngIE) {
									var i, div;
									for (i = 0; i <= 11; i++) {
								...
								cal.find("div.colpick_hue").on(
										"mousedown touchstart", downHue);
								options.newColor = cal
										.find("div.colpick_new_color");
			...
			setColor : function(col, setCurrent) {
				if (col != undefined) {
					setCurrent = (typeof setCurrent === "undefined") ? 1
							: setCurrent;
					if (typeof col == "string") {
						col = hexToHsb(col)
					} else {
						if (col.r != undefined && col.g != undefined
								&& col.b != undefined) {
							col = rgbToHsb(col)
						} else {
							if (col.h != undefined && col.s != undefined
									&& col.b != undefined) {
								col = fixHSB(col)
							} else {
								return this
					...
					return this.each(function() {
						if ($(this).data("colpickId")) {
							...
							cal.data("colpick").onChange.apply(cal.parent(), [
									col, hsbToHex(col), hsbToRgb(col),
									cal.data("colpick").el, 1 ]);
							if (setCurrent) {
								setCurrentColor(col, cal.get(0))
							}
						}
...
(function(window) {
	...
	Tablet.prototype._init = function(_container, config) {
		...
		this.isMobile = isMobile = /phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone/i
		...
		this.config.onInit && (typeof this.config.onInit === "function")
	...
	Tablet.prototype._ctxInit = function() {
		...
		}, clientRect = that.clientRect = that.canvas.getBoundingClientRect(), pressed = this.pressed = false, create = function(
				singal) {
			return function(e) {
				e.preventDefault();
				if (singal === 1) {
		...
		var start = create(1), move = create(2), animationMove = window.requestAnimationFrame ? function(
				e) {
	...
	Tablet.prototype._bindEvent = function() {
		...
		this.tablet
				...
				.on(
						"click",
						function() {
							if (that.config.onBeforeClear
									&& (typeof that.config.onBeforeClear === "function")) {
							...
							that.clear();
							that.config.onBeforeClear
									&& (typeof that.config.onBeforeClear === "function")
									&& that.config.onBeforeClear.call(this)
						})
	};
	...
	Tablet.prototype.setCanvasWH = function(width, height) {
		var that = this, $tabletBtns = this.tablet.find(".tablet-btns"), bt = parseFloat(
				this.$canvas.css("border-top-width"), 10), bb = parseFloat(
				this.$canvas.css("border-bottom-width"), 10), bl = parseFloat(
				this.$canvas.css("border-left-width"), 10), br = parseFloat(
				this.$canvas.css("border-right-width"), 10);
		if (!width || !height) {
			...
			if (!that.isMobile) {
				...
				_w = window.innerWidth || document.documentElement.clientWidth
						|| document.body.clientWidth;
				_h = winH;
...
//			this.canvas.height = this.height
//		}
		console.log("canvas适应屏幕宽度、固定高度："+ this.width+","+window.self_init_canvas_height);
		this.canvas.width = this.width;
		this.canvas.height = window.self_init_canvas_height;
		return this
	};
	...
	Tablet.prototype.getBlob = function(type) {
		var that = this, base64Img = this.getBase64(type), arr = base64Img
				.split(","), mime = arr[0].match(/:(.*?);/)[1], bStr = atob(arr[1]), len = bStr.length, u8arr = new Uint8Array(
				len);
		while (len--) {
	...
	Tablet.prototype.rotate = function(degree) {
		var minDeg = -90, maxDeg = 180, angle = 0, that = this, translateLen = 0, winW = $(
				window).width(), winH = $(window).height(), w = winW, h = winH, newCanvas = $("<canvas>");
		degree = ~~degree;
		if (degree < minDeg) {
			degree = minDeg
		}
		...
		this.tablet.children().css(
				{
					transform : "rotate(" + degree + "deg) translate("
							+ translateLen + "px," + translateLen + "px)",
	...
	Tablet.prototype.buildTablet = function() {
		...
		html += '<div class="-tablet ' + flex + this.config.extraClass
				+ '" id="' + this.id + '">';
		...
		html += "        </div>";
		if (typeof this.config.otherHtml === "string"
				&& this.config.otherHtml.length > 0) {
	...
	Tablet.getMax = function(xPoints, yPoints) {
		...
		if (({}).toString.call(xPoints) !== "[object Array]"
				|| ({}).toString.call(yPoints) !== "[object Array]") {
			return obj
		}
